...
export default function FaturamentoHero({ faturamento, variacaoPct, media3meses, servicosRealizados }: Props) {
  ...
  const ticketMedio = servicosRealizados > 0 ? faturamento / servicosRealizados : 0
